                    ...
                    <div class="col-md-12">
                        <div class="card">
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col">
                                                    <div class="card-title">Detail Mahasiswa, <strong>{{$data->mahasiswaTerpilih->user->name}}</strong></div>
                                            </div>
                                            <div>
                                ...
                                <div class="card-body">
                                    <div class="py-4">                                         
                                        <div class="row">
                                            ...
                                            <div>{{$data->nim_terpilih}}</div>
                                        </div>
                
                                        <div class="row mt-3">
                                            <div class="col-2">Nama</div>
                                            <div class="col-1"><span class="float-right">:</span></div>
                                            <div>{{ $data->mahasiswaTerpilih->user->name}}</div>
                                        </div>
