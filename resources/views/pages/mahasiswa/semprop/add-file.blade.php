            ...
            <div class="row mt--2">
                ...
                @else
                    ...
                    @if ($syarat_pembayaran)
                        ...
                        <div class="col-md-12">
                            <div class="card full-height">
                                <form action="{{ url('daftar-semprop/'.$syarat_pembayaran->id)}}" method="POST" enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    @endif
                                                    <a href="{{ url('view_file/'.$syarat_pembayaran->id) }}" target="_blank" class="btn btn-secondary btn-xs ml-3"> <i class="fas fa-eye"></i> View</a>
            ...
            <div class="row mt--2">
                ...
                @else
                    ...
                    @if ($syarat_toefl)
                        ...
                        <div class="col-md-12">
                            <div class="card full-height">
                                <form action="{{ url('daftar-semprop/'.$syarat_toefl->id)}}" method="POST" enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <span class="badge badge-default"> <i class="fas fa-spinner"></i> Waiting</span>
                                                    @endif
                                                    <a href="{{ url('view_file/'.$syarat_toefl->id) }}" target="_blank" class="btn btn-secondary btn-xs ml-3"> <i class="fas fa-eye"></i> View</a>
            ...
            <div class="row mt--2">
                ...
                @else
                    ...
                    @if ($syarat_naskah)
                        ...
                        <div class="col-md-12">
                            <div class="card full-height">
                                <form action="{{ url('daftar-semprop/'.$syarat_naskah->id)}}" method="POST" enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <span class="badge badge-default"> <i class="fas fa-spinner"></i> Waiting</span>
                                                    @endif
                                                    <a href="{{ url('view_file/'.$syarat_naskah->id) }}" target="_blank" class="btn btn-secondary btn-xs ml-3"> <i class="fas fa-eye"></i> View</a>
            ...
            <div class="row mt--2">
                ...
                @else
                    ...
                    @if ($syarat_transkip)
                        ...
                        <div class="col-md-12">
                            <div class="card full-height">
                                <form action="{{ url('daftar-semprop/'.$syarat_transkip->id)}}" method="POST" enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <span class="badge badge-default"> <i class="fas fa-spinner"></i> Waiting</span>
                                                    @endif
                                                    <a href="{{ url('view_file/'.$syarat_transkip->id) }}" target="_blank" class="btn btn-secondary btn-xs ml-3"> <i class="fas fa-eye"></i> View</a>
